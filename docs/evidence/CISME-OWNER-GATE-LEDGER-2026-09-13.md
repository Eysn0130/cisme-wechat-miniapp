...
> 2026-09-20 生效更新：Owner 已明确要求将最新完整代码收敛到唯一主目录并同步 GitHub main；当前工程入口为[本轮代码审核记录](main-consolidation-20260920/README.md)。下文要求停留在旧 PR/Draft、按 PR1→PR2→PR3 等待合并的流程属于历史，不再作为此次源码同步的阻塞。真实资金、平台、staging、隐私与完整原生/真机验收缺口仍保留；源码同步不等于这些门禁通过。历史数量和 SHA 不继承为当前检查结果。
