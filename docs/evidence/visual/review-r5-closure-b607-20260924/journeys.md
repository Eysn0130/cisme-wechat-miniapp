...
Each journey must be recorded against `local-worktree:61f895e79ebd+b6073d63231f` using synthetic or staging test data. Success means the server-authoritative terminal state is visible; a spinner or tap response is not business completion.
