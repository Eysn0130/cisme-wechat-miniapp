...
Each journey must be recorded against `local-worktree:2df301818c55+728cdc6cdfff` using synthetic or staging test data. Success means the server-authoritative terminal state is visible; a spinner or tap response is not business completion.
