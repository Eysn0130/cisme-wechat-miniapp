...
Each journey must be recorded against `local-worktree:b346cb6c51a6+a7a92a2b41ef` using synthetic or staging test data. Success means the server-authoritative terminal state is visible; a spinner or tap response is not business completion.
