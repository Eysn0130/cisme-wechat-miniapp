...
Each journey must be recorded against `local-worktree:4994dabe10a7+005f03d43a58` using synthetic or staging test data. Success means the server-authoritative terminal state is visible; a spinner or tap response is not business completion.
