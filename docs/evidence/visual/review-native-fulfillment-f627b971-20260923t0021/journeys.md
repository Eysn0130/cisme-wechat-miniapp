...
Each journey must be recorded against `local-worktree:f4c8df9e5be0+f627b9714437` using synthetic or staging test data. Success means the server-authoritative terminal state is visible; a spinner or tap response is not business completion.
