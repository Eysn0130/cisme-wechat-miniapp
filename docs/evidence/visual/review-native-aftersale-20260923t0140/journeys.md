...
Each journey must be recorded against `local-worktree:a659e050ef32+6ec7f596056c` using synthetic or staging test data. Success means the server-authoritative terminal state is visible; a spinner or tap response is not business completion.
