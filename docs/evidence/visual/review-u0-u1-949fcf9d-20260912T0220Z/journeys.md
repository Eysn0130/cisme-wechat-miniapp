...
Each journey must be recorded against `local-worktree:8e843a6b0a28+949fcf9da6d4` using synthetic or staging test data. Success means the server-authoritative terminal state is visible; a spinner or tap response is not business completion.
