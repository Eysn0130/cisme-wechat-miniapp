...
Each journey must be recorded against `local-worktree:2d1104d0f88c+4e551cc6c415` using synthetic or staging test data. Success means the server-authoritative terminal state is visible; a spinner or tap response is not business completion.
