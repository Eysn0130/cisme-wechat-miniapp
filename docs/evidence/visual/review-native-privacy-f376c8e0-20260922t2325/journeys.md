...
Each journey must be recorded against `local-worktree:11eff1689b52+f376c8e0a5ad` using synthetic or staging test data. Success means the server-authoritative terminal state is visible; a spinner or tap response is not business completion.
