# CISME Visual Review Pack — native-privacy-f376c8e0-20260922t2343

Generated: 2026-09-22T23:49:06.528Z

This pack is bound to Mini Program source SHA-256 `f376c8e0a5ad8b924154acaf9528a3bbbea4772106396fdc4fe632bcc624dcda` and local Git HEAD `c63768a93fa89ba158288abd6f3663b9dbdbf074` on branch `codex/fulfillment-lifecycle-20260922`. Observed worktree dirty: true. The source hash, not HEAD alone, is the review identity; this generator does not infer push or merge status.

## Honest result

- Dynamic route inventory: 38/38 routes indexed from `app.json`.
- Current-source raw native screenshots: 38/38; each is an untouched 333×719 simulator frame.
