...
Each journey must be recorded against `local-worktree:c63768a93fa8+f376c8e0a5ad` using synthetic or staging test data. Success means the server-authoritative terminal state is visible; a spinner or tap response is not business completion.
