...
后续事实更新：PR16–19 已合并，main 源码为 `ae31437652e2fe3fbb24e7ac493d3b60ad747d27`，main CI35697496015 成功。下文是当时施工记录；云控制台/TAT 访问和 staging 身份核验已在 [后续环境记录](../launch-unblock-20260922/README.md) 中解除，未因此扩大原生、真机或发布结论。
