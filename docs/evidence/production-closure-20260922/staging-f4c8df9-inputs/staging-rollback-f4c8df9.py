...
ROOT=pathlib.Path('/opt/cisme');SOURCE='f4c8df9e5be091b246e9893b1c357bc004d943b0';PREVIOUS='2df301818c550ae6d19649d44f785d02fb58b276'
...
def main(run):
    ...
    require(previous==ROOT/'releases'/'rc20260922-690f9382-2df301818c55' and manifest['sourceHead']==PREVIOUS,'EXACT_PREVIOUS_RELEASE_REQUIRED')
    require(manifest['hashes'].get('index.js')=='f66df6b53ab324a906fab824568522d15eb868c122ee1af26ee16416c2a96ce8','PREVIOUS_API_DRIFT')
