...
SOURCE = 'f4c8df9e5be091b246e9893b1c357bc004d943b0'
...
def main(run_id):
    ...
    require(counts['members']['source']==2 and counts['privacyRequests']['source']==1 and counts['revokedGrants']['source']==2,'SYNTHETIC_BUSINESS_FACTS_REQUIRED')
