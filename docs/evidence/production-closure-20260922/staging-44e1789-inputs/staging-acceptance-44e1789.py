...
SOURCE = '44e1789c5998fa21b905bf4a0fca02799ffe3e68'
...
def main(run_id):
    ...
    require(all(row['source'] == row['restored'] for row in counts.values())
            and counts['migrations']['restored'] == 76 and counts['marker']['restored'] == 1, 'RESTORE_COUNTS_MISMATCH')
    ...
    require(counts['members']['source']==2 and counts['privacyRequests']['source']==1 and counts['revokedGrants']['source']==3,'SYNTHETIC_BUSINESS_FACTS_REQUIRED')
