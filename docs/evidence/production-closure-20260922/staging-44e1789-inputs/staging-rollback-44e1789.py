...
ROOT=pathlib.Path('/opt/cisme');SOURCE='44e1789c5998fa21b905bf4a0fca02799ffe3e68';PREVIOUS='f346736d379e9d8b177426f17ffb58a4e4e32cca'
...
def main(run):
    ...
    require(previous==ROOT/'releases'/'rc20260922-35bce2d8-f346736d379e' and manifest['sourceHead']==PREVIOUS,'EXACT_PREVIOUS_RELEASE_REQUIRED')
    require(manifest['hashes'].get('index.js')=='9e37763d75bf4d189a5dad22de238d56fbffa9ce4863011789d30078cbdae0de','PREVIOUS_API_DRIFT')
