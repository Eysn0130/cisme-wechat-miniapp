...
Page({
 lastSessionToken:"",
 data:{...initialRuntimeView(),chromeStyle:currentChromeStyle(),authority:null as AuthorityProjection|null,canSupport:false,canCatalog:false,canOrders:false,canMembers:false,canFinance:false,coreReady:false,loading:true,navigating:false,error:"",epoch:0,alive:true,visible:true,runtimeEpoch:0},
 onResize(){this.setData({chromeStyle:currentChromeStyle()});},
 onShow(){this.data.alive=true;this.data.visible=true;this.setData({navigating:false});void this.load();},
 onHide(){this.data.visible=false;this.data.epoch+=1;this.data.runtimeEpoch+=1;cancelPageReads(this);cancelRuntimeRead(this);this.setData({canSupport:false,canCatalog:false,canOrders:false,canMembers:false,canFinance:false,coreReady:false});},
 ...
 async load(){if(!this.data.visible)return;cancelPageReads(this);cancelRuntimeRead(this);
  ...
  this.setData({authority:null,canSupport:false,canCatalog:false,canOrders:false,canMembers:false,canFinance:false,coreReady:false,loading:true,error:""});
