...
ROOT=pathlib.Path('/opt/cisme');SOURCE='2df301818c550ae6d19649d44f785d02fb58b276';PREVIOUS='0f1b4c346173ed26d6ffd3d6e3612ef893b14212'
...
def main(run):
    ...
    require(previous==ROOT/'releases'/'rc20260922-9ac72e41-0f1b4c346173' and manifest['sourceHead']==PREVIOUS,'EXACT_PREVIOUS_RELEASE_REQUIRED')
    require(manifest['hashes'].get('index.js')=='37d3fdbe92006a42e6d3b9a037e4cec55e1f433f78d0ee404096fb57d72dfe4f','PREVIOUS_API_DRIFT')
