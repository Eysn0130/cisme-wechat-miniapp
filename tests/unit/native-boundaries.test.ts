...
describe("native mini program boundary", () => {
  ...
  it("locks the per-route button action inventory and verifies every handler exists", async () => {
    ...
    const expected: Record<string, string[]> = {
      ...
      aftersale: ["back", "retry", "retry", "submit", "reconcile", "open", "next", "submit", "list", "submit"],
      "management-fulfillment": ["back", "retry", "retry", "next", "exportExcel", "submit", "reconcileBatch", "newBatch"],
      "management-privacy": ["back", "retry", "retry", "select", "retry", "submit", "closeDetail"],
      ...
      "order-detail": ["back", "back", "load", "retryRuntime", "resolveRecovery", "loadRecovery", "openAftersale", "loadShipment", "confirmReceipt", "loadTracking", "showRefundForm", "closeRefundForm", "submitRefund", "retryRefunds", "loadMoreRefunds", "preparePayment", "recheckPayment", "cancel"],
