...
describe("native mini program boundary", () => {
  ...
  it("locks the per-route button action inventory and verifies every handler exists", async () => {
    ...
    const expected: Record<string, string[]> = {
      ...
      commission: ["back", "load", "showForm", "closeForm", "submit", "retryList", "more"],
      ...
      management: ["back", "retry", "openSupport", "openCatalog", "openOrders", "openMembers", "openFinance"],
      ...
      "management-finance": ["back", "selectSection", "importBill", "importBill", "retry", "decide", "decide", "decide", "operateIssue", "operateIssue", "loadMore"],
