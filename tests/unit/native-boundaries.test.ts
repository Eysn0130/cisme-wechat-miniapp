...
describe("native mini program boundary", () => {
  ...
  it("locks the per-route button action inventory and verifies every handler exists", async () => {
    ...
    const expected: Record<string, string[]> = {
      ...
      management: ["back", "retry", "retryRuntime", "openSupport", "openCatalog", "openOrders", "openFulfillment", "openAftersale", "openMembers", "openPrivacy", "openFinance"],
      ...
      aftersale: ["back", "retry", "retry", "submit", "reconcile", "open", "next", "submit", "list", "openChat", "submit"],
      ...
      "order-detail": ["back", "back", "load", "retryRuntime", "resolveRecovery", "loadRecovery", "expandSupport", "closeSupportSheet", "openFullAftersale", "submitSheetAftersale", "sendSheetMessage", "openAftersale", "loadShipment", "confirmReceipt", "loadTracking", "showRefundForm", "closeRefundForm", "submitRefund", "retryRefunds", "loadMoreRefunds", "preparePayment", "recheckPayment", "cancel"],
