...
describe("native mini program boundary", () => {
  ...
  it("locks the per-route button action inventory and verifies every handler exists", async () => {
    ...
    const expected: Record<string, string[]> = {
      ...
      management: ["back", "retry", "retryRuntime", "openSupport", "openCatalog", "openOrders", "openFulfillment", "openMembers", "openPrivacy", "openFinance"],
      ...
      "order-detail": ["back", "back", "load", "retryRuntime", "resolveRecovery", "loadRecovery", "loadShipment", "confirmReceipt", "loadTracking", "showRefundForm", "closeRefundForm", "submitRefund", "retryRefunds", "loadMoreRefunds", "preparePayment", "recheckPayment", "cancel"],
